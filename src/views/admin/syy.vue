<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 表格 -->
      <tree class="treeTable" :data="catelist" 
      :columns="columns"
      ...
      <el-pagination
       @size-change="handleSizeChange"
        @current-change="handleCurrentChange"
         :current-page="curr.pagenum"
          :page-sizes="[3, 5, 10]"
           :page-size="curr.pagesize"
    ...
    <!-- 添加分类的对话框 -->
    <el-dialog title="添加分类" :visible.sync="dialogTableVisible" width="50%" @close="addCateDialogClosed">
      <!-- 添加分类的表单 -->
...
export default {
  ...
  methods: {
    ...
    handleSizeChange(newSize) {
        console.log(newSize)
      this.curr.pagesize = newSize
      this.getCateList()
    },
    handleCurrentChange(newPage) {
        console.log(newPage)
      this.curr.pagenum = newPage
      this.getCateList()
    },
  }
}
